...
namespace CryPay\HttpClient;

use CryPay\Exception\ApiConnectionException;
use CryPay\Exception\UnexpectedValueException;
    ...
    private function handleCurlError(string $url, int $errno, string $message)
    {
        switch ($errno) {
            ...
            case CURLE_OPERATION_TIMEOUTED:
                $response = "Could not connect to CryPay ($url). "
            ...
            case CURLE_SSL_PEER_CERTIFICATE:
                $response = "Could not verify CryPay's SSL certificate. "
            ...
            default:
                $response = "Unexpected error communicating with CryPay. ";
        }

        $response .= 'If this problem persists, let us know at https://support.crypay.com.';
